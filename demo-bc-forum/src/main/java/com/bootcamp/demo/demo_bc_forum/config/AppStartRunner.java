...
import com.bootcamp.demo.demo_bc_forum.mapper.CommentEntityMapper;
import com.bootcamp.demo.demo_bc_forum.mapper.PostEntityMapper;
import com.bootcamp.demo.demo_bc_forum.mapper.UserEntityMapper;
import com.bootcamp.demo.demo_bc_forum.repository.CommentRepository;
import com.bootcamp.demo.demo_bc_forum.repository.PostRepository;
  ...
  public void run(String... args) throws Exception {
    ...
    List<CommentEntity> commentEntities =
        this.jphService.getAllComments().stream() //
            .map(c -> {
              CommentEntity commentEntity = this.commentEntityMapper.commentEntityMap(c);
    ...
    //List<CommentEntity> commentEntities = List.of(new CommentEntity(null, "test", "est", "ssss", postEntities.get(0)));
